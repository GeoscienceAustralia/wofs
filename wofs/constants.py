...
0    1              1<<0        nodata or noncontiguous (missing all or one earth observation bands) 
1    2              1<<1        high aerosol or high atmospheric opacity
...
MASKED_AEROSOL = 1 << 1  # (dec 2)   bit 1: 1=pixel masked out due to high aerosol or high opacity
MASKED_NO_CONTIGUITY = 1 << 0  # (dec 1)   bit 0: 1=pixel masked out due to lack of data contiguity
