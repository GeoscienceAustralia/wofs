"""
A collection of WaterFilter classes to support
Pixel Quality filtering of the  water bands produced by the water classifier
from wofs-v1
"""
import numpy
import numexpr
from wofs.waters.WaterConstants import WATER_NOT_PRESENT, WATER_PRESENT, NO_DATA, MASKED_NO_CONTIGUITY, MASKED_CLOUD, \
    MASKED_CLOUD_SHADOW, \
