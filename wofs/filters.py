...
def c2_filter(pq):
    ...
    masking[((pq & C2_CLOUD_BITS)).astype(np.bool) | ((pq & C2_CIRRUS_BITS)).astype(np.bool)] += constants.MASKED_CLOUD
    #masking[((pq & C2_CIRRUS_BITS)).astype(np.bool)] += constants.MASKED_CLOUD
